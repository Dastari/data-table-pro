...
import { ColumnDef, Table, AggregationFnDef, filterFns, RowData, CellContext, FilterFnOption, Row, Cell, Header, Column, HeaderContext, ColumnFiltersState, SortingState, GroupingState, ExpandedState, ColumnOrderState, RowPinningState, ColumnVisibilityState, PaginationState, ColumnSizingState, Updater } from '@tanstack/react-table';
import * as React from 'react';

type BuiltInFilterFn = (typeof filterFns)[keyof typeof filterFns];
declare const dataTableFeatures: {
    ...
    rowAggregationFeature: _tanstack_react_table.TableFeature;
    columnGroupingFeature: _tanstack_react_table.TableFeature;
    columnOrderingFeature: _tanstack_react_table.TableFeature;
    columnPinningFeature: _tanstack_react_table.TableFeature;
    columnSizingFeature: _tanstack_react_table.TableFeature;
    columnResizingFeature: _tanstack_react_table.TableFeature;
    ...
    rowPinningFeature: _tanstack_react_table.TableFeature;
    rowSelectionFeature: _tanstack_react_table.TableFeature;
    rowSortingFeature: _tanstack_react_table.TableFeature;
    expandedRowModel: (table: Table<any, any>) => () => _tanstack_react_table.RowModel<any, any>;
    facetedMinMaxValues: (table: Table<_tanstack_react_table.TableFeatures, any>, columnId: string) => () => undefined | [number, number];
    facetedRowModel: (table: Table<any, any>, columnId: string) => () => _tanstack_react_table.RowModel<any, any>;
    facetedUniqueValues: (table: Table<_tanstack_react_table.TableFeatures, any>, columnId: string) => () => Map<any, number>;
    filteredRowModel: (table: Table<any, any>) => () => _tanstack_react_table.RowModel<any, any>;
    groupedRowModel: (table: Table<any, any>) => () => _tanstack_react_table.RowModel<any, any>;
    paginatedRowModel: (table: Table<any, any>) => () => _tanstack_react_table.RowModel<any, any>;
    sortedRowModel: (table: Table<any, any>) => () => _tanstack_react_table.RowModel<any, any>;
    aggregationFns: {
        [x: string]: AggregationFnDef<any, any, unknown, unknown>;
    };
    filterFns: Record<string, BuiltInFilterFn>;
    sortFns: {
...
type DataTableRowData<TData> = Extract<TData, RowData>;
type DataTableTanStackTable<TData> = Table<DataTableFeatures, DataTableRowData<TData>>;
type DataTableTanStackRow<TData> = Row<DataTableFeatures, DataTableRowData<TData>>;
type DataTableTanStackColumn<TData, TValue = unknown> = Column<DataTableFeatures, DataTableRowData<TData>, TValue>;
type DataTableTanStackCell<TData, TValue = unknown> = Cell<DataTableFeatures, DataTableRowData<TData>, TValue>;
type DataTableTanStackHeader<TData, TValue = unknown> = Header<DataTableFeatures, DataTableRowData<TData>, TValue>;
type DataTableTanStackColumnDef<TData, TValue = unknown> = ColumnDef<DataTableFeatures, DataTableRowData<TData>, TValue>;
type DataTableTanStackCellContext<TData, TValue = unknown> = CellContext<DataTableFeatures, DataTableRowData<TData>, TValue>;
type DataTableTanStackHeaderContext<TData, TValue = unknown> = HeaderContext<DataTableFeatures, DataTableRowData<TData>, TValue>;
type DataTableTanStackFilterFnOption<TData> = FilterFnOption<DataTableFeatures, DataTableRowData<TData>>;
type DataTableTanStackAggregationFn<TData> = AggregationFnDef<DataTableFeatures, DataTableRowData<TData>>;
...
type DataTableAggregationFn<TData> = DataTableTanStackAggregationFn<TData>;
...
type DataTableCellEditRenderProps<TData, TValue> = {
    cell: DataTableTanStackCellContext<TData, TValue>;
    row: TData;
...
type DataTableColumnMeta<TData, TValue> = {
    ...
    skeleton?: (context: DataTableTanStackCellContext<TData, TValue>) => React.ReactNode;
    filter?: DataTableColumnFilterConfig<TData, TValue>;
    parseEditValue?: (value: unknown, context: DataTableTanStackCellContext<TData, TValue>) => unknown;
    formatEditValue?: (value: unknown, context: DataTableTanStackCellContext<TData, TValue>) => string;
    renderEditCell?: (props: DataTableCellEditRenderProps<TData, TValue>) => React.ReactNode;
};
type DataTableColumnDef<TData, TValue = unknown> = DataTableTanStackColumnDef<TData, TValue> & {
...
type DataTableExpandedRowProps<TData> = {
    row: TData;
    rowId: string;
    tableRow: DataTableTanStackRow<TData>;
};
...
type DataTableApi<TData> = {
    getTable: () => DataTableTanStackTable<TData> | null;
...
type DataTableProps<TData> = {
    ...
    globalFilterFn?: DataTableTanStackFilterFnOption<TData>;
    columnFilters?: ColumnFiltersState;
...
declare function headerAlignClassName<TData, TValue>(context: DataTableTanStackHeaderContext<TData, TValue>): "text-center" | "text-right" | "text-left";
declare function cellAlignClassName<TData, TValue>(context: DataTableTanStackCellContext<TData, TValue>): "text-center" | "text-right" | "text-left";
...
declare function rowSelectionStateFromRows<TData>(rows: Array<DataTableTanStackRow<TData>>): Extract<TData, _tanstack_react_table.RowData>[];

export { type DataTablePersistenceOperation as $, type DataTableColumnGroupDef as A, type DataTableColumnMeta as B, type DataTableColumnPinningState as C, type DataTableProps as D, type DataTableColumnPrefs as E, type DataTableColumnType as F, type DataTableColumnVisibilityOption as G, type DataTableContainerBreakpoint as H, type DataTableCsvExportOptions as I, type DataTableCsvExportScope as J, type DataTableDensity as K, type DataTableDetailPanel as L, type DataTableDragAndDropConfig as M, type DataTableEditableRowsConfig as N, type DataTableEmptyStateContext as O, type DataTableExpandedRowProps as P, type DataTableFacetedFilterOptions as Q, type DataTableFileUploadConfig as R, type DataTableGridCommandContext as S, type DataTableGridCommands as T, type DataTableHiddenRowsConfig as U, type DataTableInfiniteScroll as V, type DataTableInitialState as W, type DataTableInteractiveGridOptions as X, type DataTableLabels as Y, type DataTableLoadingState as Z, type DataTablePersistenceConfig as _, DATA_TABLE_CONTAINER_BREAKPOINT_WIDTHS as a, type DataTablePersistencePayload as a0, type DataTablePersistenceSlice as a1, type DataTablePersistenceStorage as a2, type DataTableResetOptions as a3, type DataTableRowAction as a4, type DataTableRowClassNameContext as a5, type DataTableRowLoadingState as a6, type DataTableSavedView as a7, type DataTableSavedViewSlice as a8, type DataTableSavedViewsChangeOperation as a9, type DataTableTanStackColumn as aA, type DataTableTanStackCell as aB, type DataTableTanStackTable as aC, type DataTableTanStackHeader as aD, type DataTableTanStackColumnDef as aE, type DataTableTanStackFilterFnOption as aF, type DataTableSavedViewsConfig as aa, type DataTableSavedViewsPayload as ab, type DataTableScrollbarVisibility as ac, type DataTableSelectionAction as ad, type DataTableSelectionActionContext as ae, type DataTableState as af, type DataTableStateOverlay as ag, type DataTableStateOverlayContext as ah, type DataTableSummaryRow as ai, type DataTableToolbarAction as aj, type DataTableToolbarDataOperations as ak, type DataTableToolbarVisibility as al, type DataTableViewMode as am, type DataTableVirtualizationConfig as an, alignClassName as ao, canEditRow as ap, canUseRowAction as aq, cellAlignClassName as ar, headerAlignClassName as as, hideOnClassName as at, isHiddenAtContainerWidth as au, isRowVisible as av, resolveColumnAlign as aw, resolveRowActionLabel as ax, rowSelectionStateFromRows as ay, type DataTableTanStackRow as az, type DataTableAccessibilityOptions as b, type DataTableActionErrorContext as c, type DataTableActionErrorSource as d, type DataTableAggregationFn as e, type DataTableAlign as f, type DataTableApi as g, type DataTableAutoPageSizeConfig as h, type DataTableCardRendererProps as i, type DataTableCardSizing as j, type DataTableCardVirtualizationConfig as k, type DataTableCellCoordinate as l, type DataTableCellEditRenderProps as m, type DataTableCellOverflow as n, type DataTableCellSelection as o, type DataTableClipboardConfig as p, type DataTableClipboardCopyOptions as q, type DataTableClipboardCopyScope as r, type DataTableClipboardPasteContext as s, type DataTableColumnDef as t, type DataTableColumnFilterConfig as u, type DataTableColumnFilterOperator as v, type DataTableColumnFilterOption as w, type DataTableColumnFilterRangeValue as x, type DataTableColumnFilterType as y, type DataTableColumnFixed as z };
